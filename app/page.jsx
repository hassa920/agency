        ...
        <section className="hp-orbit-section">
          ...
          <div className="hp-circle-wrapper">
            ...
            <div className="hp-circle">
              ...
              <div className="hp-orbit-dot hp-dot-1" />
              <div className="hp-orbit-dot hp-dot-2" />
              <div className="hp-orbit-dot hp-dot-3" />

              {/* Animated clockwise orbiting dot */}
              <div
                ref={dotRef}
                className="hp-orbit-dot"
                style={{
                  position: "absolute",
                  width: "14px",
                  height: "14px",
